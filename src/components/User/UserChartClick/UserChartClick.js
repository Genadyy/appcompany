...
import styles from "./UserChartClick.module.scss";
import { users_statistic } from "./../../users_statistic";

const UserChartClick = (props) => {
  let userStatData = [];
  ...
  const data = userStatData.map((item) => item.clicks);
